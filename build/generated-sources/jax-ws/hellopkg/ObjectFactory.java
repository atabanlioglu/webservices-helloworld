 ...
 * generated in the hellopkg package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloResponse_QNAME = new QName("http://helloPkg/", "getHelloResponse");
    private final static QName _GetHello_QNAME = new QName("http://helloPkg/", "getHello");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hellopkg
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://helloPkg/", name = "getHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://helloPkg/", name = "getHello")
